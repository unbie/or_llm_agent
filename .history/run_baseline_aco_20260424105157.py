...
def build_experiment_suite(suite_name: str = 'core4', runs_per_instance: int = 3):
...
示例:
  ...
  python run_baseline_aco.py --all --ants 60 --iter 500 --beta 4.0
    ...
    parser.add_argument('--suite', default='core4', choices=['core4', 'core12', 'full56'],
                        help='批量实例集: core4(默认) / core12 / full56')
