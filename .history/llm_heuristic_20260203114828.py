...
def visualize_results(dataset, solution, best_cost, output):
    ...
    ax2.set_title(f'车辆路线规划图 (共{len(solution)}条路线)', fontsize=14, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('vrp_result.png', dpi=300, bbox_inches='tight', facecolor='white')
    plt.close()
    print(f"[可视化] 图表已保存到 vrp_result.png")
