...
def visualize_results(dataset, solution, best_cost, output):
    ...
    if temp_history and accept_rate_history:
        ...
        accept_iters = [iterations[i*10] for i in range(len(accept_rate_history)) if i*10 < len(iterations)]
        line2 = ax2_twin.plot(accept_iters, accept_rate_history, 'green', linewidth=2.5, 
        ...
        temp_explanation = (
            ...
            f"平均接受率: {sum(accept_rate_history)/len(accept_rate_history)*100:.1f}%"
        )
