...
Examples:
  ...
  python run_baseline_alns.py --all --maxiter 1500
    ...
    parser.add_argument('--first-only', action='store_true', help='Only run the first instance in the suite')
    parser.add_argument('--runs',     type=int, default=None, help='Override runs per instance in batch mode')
    ...
    parser.add_argument('--maxiter',  type=int, default=1000, help='Max ALNS iterations (default 1000)')
